...
const NewEducation = () => {
    ...
    const addEducation = async (e) => {
        ...
        await axios({
              method: 'POST',
              url: `http://127.0.0.1:8000/user/education/`,
              data: formField,
                   headers: {
                       'Content-Type': 'application/json',
                       'Authorization': 'Bearer ' + String(authTokens.access)
            ...
            if (response.status === 201) {
                ...
                setEstablishment("")
                setDescription("")
                setSuccessMessage("Education Ajouter Avec success")
                setShow(true)
            }
        ...
        <div className="new">
            ...
            <div className="newContainer">
                ...
                <div className="newtop">
                    <div>
                        <h1 className="newtitle">Ajouter Education </h1>
                    </div>
                <form>
                    <Container>
                        <Row>
                        ...
                        <Row>
                                <Col md={{ span: 6, offset: 4 }}>
                                 <button className="newbutton" type="submit" onClick={addEducation}>Ajouter</button>
                            </Col>
                        </Row>
                    </Container>
                    </form>
